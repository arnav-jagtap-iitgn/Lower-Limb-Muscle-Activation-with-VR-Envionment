...
goal_left.setPosition(-11.4, 0.01, 0)  # Position at the left goal
goal_left.setEuler(-90, 0, 0)         # Rotate to face the field
goal_left.setScale(0.008, 0.006, 0.007)

# Place the right goalpost
goal_right.setPosition(11.4, 0.01, 0)  # Position at the right goal
goal_right.setEuler(90, 0, 0)       # Rotate to face the field
goal_right.setScale(0.008, 0.006, 0.007)

# Place the top goalpost
goal_top.setPosition(0, 0.01, 11.4)  # Position at the top goal
goal_top.setEuler(0, 0, 0)         # Rotate to face the field
goal_top.setScale(0.008, 0.006, 0.007)
...
def checkGoal():
    global score, current_task, field_size, break_in_progress, game_complete, ball_inside_goal, time_inside_goal, la
    ...
    if current_task < len(goal_positions):
        ...
        corner_width = (goal_max[0] - goal_min[0]) * 0.2
        corner_depth = (goal_max[2] - goal_min[2]) * 0.2
...
def setupLevel2():
    ...
    goal_left_level2.setPosition(-16.4, 0.01, 0)
    goal_left_level2.setScale(0.008, 0.006, 0.007)
    goal_left_level2.setEuler(-90, 0, 0)

    goal_right_level2.setPosition(16.4, 0.01, 0)
    goal_right_level2.setScale(0.008, 0.006, 0.007)
    goal_right_level2.setEuler(90, 0, 0)

    goal_top_level2.setPosition(0, 0.01, 16.4)
    goal_top_level2.setScale(0.008, 0.006, 0.007)
